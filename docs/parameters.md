...
| LambdaSessionByTokenRetry | No       | `false`                | Feature flag for RETRY_SESSION_BY_AUTH_CODE. This adds a retry to session retrieval in the access-token handler and is currently used for investigation. | `true` |
